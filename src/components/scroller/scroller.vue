<template>
  <div ref="wrapper" class="better-scroll-root">  <!--该节点需要定位，内容以此节点的盒模型为基础滚动。另外，该节点的背景色配合上拉加载、下拉刷新的UI，正常情况下不可作它用。-->
    <div class="content-bg better-scroll-container" style="min-height: 101%;">  <!--如果需要调滚动内容的背景色，则改该节点的背景色-->
      <div> <!--不太需要，待优化-->
        ...
        <div v-show="loadingStatus.showIcon || Boolean(loadingStatus.status)" class="loading-pos">
      ...
      <load-more v-if="loadingData" tip="努力加载中"></load-more>
      <divider v-if="loadOver">我是有底线的</divider>
    </div>
